...
import { StatusProgressBarComponent } from 'src/app/shared/status-progress-bar/status-progress-bar.component';
...
@NgModule({
  declarations: [
    VolunteersComponent, ListComponent, HeaderComponent, TitleComponent, VolunteerCard, StatusComponent, StatusProgressBarComponent
  ],
  imports: [
    CommonModule,
